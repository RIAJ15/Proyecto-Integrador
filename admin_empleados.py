...
def admin_empleados_view(page: ft.Page, nombre_admin: str = "Administrador") -> ft.View:
    ...
    def pintar_tabla(lista):
        ...
        for emp in lista:
            emp_id = int(emp["IdEmpleado"])

            def editar_click(e, empleado=emp):
                abrir_dialogo_editar(empleado)

            def eliminar_click(e, id_emp=emp_id):
                confirmar_eliminar(id_emp)
            ...
            tabla.rows.append(
                ft.DataRow(
                    cells=[
                        ft.DataCell(ft.Text(str(emp.get("IdEmpleado", "")))),
                        ft.DataCell(ft.Text(str(emp.get("Nombre", "")))),
                        ft.DataCell(ft.Text(str(emp.get("Apellido", "")))),
                        ft.DataCell(ft.Text(str(emp.get("Telefono", "")))),
                        ft.DataCell(ft.Text(str(emp.get("Correo", "")))),
                        ft.DataCell(ft.Text(str(emp.get("NombreUsuario", "")))),
    ...
    def abrir_dialogo_nuevo(e=None):
        ...
        dlg = ft.AlertDialog(title=ft.Text("Nuevo empleado"))
    ...
    def abrir_dialogo_editar(empleado: dict):
        txt_nombre = ft.TextField(label="Nombre", border_radius=12, value=str(empleado.get("Nombre", "")))
        txt_apellido = ft.TextField(label="Apellido", border_radius=12, value=str(empleado.get("Apellido", "")))
        ...
        txt_correo = ft.TextField(label="Correo", border_radius=12, value=str(empleado.get("Correo", "")))
        txt_usuario = ft.TextField(label="Nombre de usuario", border_radius=12, value=str(empleado.get("NombreUsuario", "")))
        ...
        dlg = ft.AlertDialog(title=ft.Text(f"Editar empleado #{empleado.get('IdEmpleado')}"))
    ...
    def confirmar_eliminar(id_empleado: int):
        dlg = ft.AlertDialog(title=ft.Text("Eliminar empleado"))
        ...
        dlg.content = ft.Text("¿Deseas eliminar este empleado y su usuario?")
        dlg.actions = [
            ft.TextButton("Cancelar", on_click=lambda ev: close_dialog(dlg)),
    ...
    return ft.View(route="/admin_empleados", controls=[layout], appbar=appbar)